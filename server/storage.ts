Warning: truncated output (original token count: 27551)
Total output lines: 2523
...
export class MemStorage implements IStorage {
  ...
  private seedSampleData() {
    ...
    // Demo credentials are injected only in an explicitly configured demo environment.
    ...
    const sampleRequests: TravelRequest[] = [
      ...
      },
      {
        ...
        visaCheck: { status: "ACTION", messag…15551 tokens truncated…ti', status: 'approved' },
