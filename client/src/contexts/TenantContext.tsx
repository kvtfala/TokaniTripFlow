...
const TENANT_CONFIGS: Record<string, TenantConfig> = {
  ...
  thc001: {
    companyCode: "thc001",
    companyName: "Tuvalu High Commission",
    tagline: "Official Travel Coordination — Tuvalu High Commission",
    logoPath: null,
    primaryHSL: "220 61% 26%",
    primaryForegroundHSL: "0 0% 100%",
    accentHSL: "40 78% 45%",
    accentForegroundHSL: "0 0% 100%",
    accentColor: "#C9951A",
    sidebarPrimaryHSL: "220 61% 26%",
    sidebarPrimaryForegroundHSL: "0 0% 100%",
  },
  khc001: {
    companyCode: "khc001",
    companyName: "Kiribati High Commission",
    tagline: "Official Travel Coordination — Kiribati High Commission",
    logoPath: null,
    primaryHSL: "213 69% 33%",
    primaryForegroundHSL: "0 0% 100%",
    accentHSL: "157 81% 30%",
    accentForegroundHSL: "0 0% 100%",
    accentColor: "#0E8A5C",
    sidebarPrimaryHSL: "213 69% 33%",
    sidebarPrimaryForegroundHSL: "0 0% 100%",
  },
};
